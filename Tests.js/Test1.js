const {getAllEmails,getHobbiesByAge,getStudentInAustraila,getPersonDataById,getAllIndivalAges,getIndivalFirstHobbyOfPerson,getNameAndEmailByAge,getCityAndCountryByID} = require("../Solutions.js/Solution1");
