const {getInformationById,getLastCarInformation,getAllCarModelsInSortedOrder,getAllCarYears,getLengthOfAllCarsLessThanTwoThousand,getDataForBMWAndAudi} = require("../Solutions.js/Solution3");
