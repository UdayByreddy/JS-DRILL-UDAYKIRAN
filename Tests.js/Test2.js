const {getAllUsersWhoInterestedInVideoGames,getAllUserByCountry,getAllUserWithMasterDegree,getDesignationByProgrammingLanguage} = require("../Solutions.js/Solution2");
